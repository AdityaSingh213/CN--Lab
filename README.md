...
Send data (Simple PDU) between multiple PCs at the same time
Observe collision in the simulation panel
💻 Configuration Commands

ping 192.168.1.2 ping 192.168.1.3 ping 192.168.1.4
...
The experiment successfully demonstrates the working of CS/CD protocol in a hub-based network. It shows that:
